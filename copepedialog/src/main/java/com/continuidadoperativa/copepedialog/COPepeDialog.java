...
public class COPepeDialog implements COPepeDialogInterface {
    private static COUtils utils;
    ...
    private COPepeDialog(AlertDialog.Builder builder, String simpleName, Activity activity) {
        dialog = builder.create();
        this.simpleName = simpleName;
        utils = new COUtils(activity);
    }
    ...
    public static class Builder {
        ...
        View view;
        COPepeDialog genericDialogBuilder;
        String simpleName;
        Activity activity;
        ...
        public Builder setPositiveButton(String text) {
            return setupPositiveButton(text, COPepeDialogInterface::dismiss);
        }

        private Builder setupPositiveButton(String text, OnClickListener listener) {
        ...
        public Builder setNegativeButton(String text) {
            return setupNegativeButton(text, COPepeDialogInterface::dismiss);
        }

        private Builder setupNegativeButton(String text, OnClickListener listener) {
        ...
        public Builder setNotShowAgain(boolean show) {
            return setupNotShowAgain(show, COPepeDialogInterface::dismiss);
        }
        ...
        public Builder setAhoraNo(boolean show) {
            return setupAhoraNo(show, COPepeDialogInterface::dismiss);
        }
        ...
        private void setupLookSample(TextView textView, String text, OnClickListener listener) {
            if (text == null || text.isEmpty()) {
                textView.setVisibility(View.GONE);
            } else {
        ...
        public Builder setBodyText(String text) {
            return setupBody(text, View.TEXT_ALIGNMENT_CENTER);
        }
        ...
        public COPepeDialog create() {
            genericDialogBuilder = new COPepeDialog(builder, simpleName, activity);
        ...
        public Builder setTitle(String text, OnClickListener listener) {
        ...
        private Builder setupTitle(String text, OnClickListener listener) {
            TextView tvTitle = view.findViewById(R.id.tvTitle);
            setupTitle(tvTitle, text, listener);
            return this;
        }

        private void setupTitle(TextView textView, String text, OnClickListener listener) {
            if (text == null || text.isEmpty()) {
                textView.setVisibility(View.GONE);
            } else {
                textView.setText(text);
